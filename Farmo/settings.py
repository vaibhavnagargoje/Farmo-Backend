...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', '127.0.0.1,localhost,api.farmo.in,4648-49-248-175-214.ngrok-free.app').split(',')

CSRF_TRUSTED_ORIGINS = os.getenv('CSRF_TRUSTED_ORIGINS', 'http://localhost:3000,https://4648-49-248-175-214.ngrok-free.app').split(',')

if DEBUG:
    CORS_ALLOW_ALL_ORIGINS = True
    CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS','http://localhost:3000,https://4648-49-248-175-214.ngrok-free.app').split(',')
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=90),   # Refresh works for 90 days (3 months)
...
if DEBUG and not EMAIL_HOST_USER:
    # In development without SMTP credentials, emails are printed to console
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
else:
    # In production (or if SMTP creds exist in dev), use real SMTP
